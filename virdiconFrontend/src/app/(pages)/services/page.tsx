        ...
        <Parallax
            ...
            {services.map((item, index) => (
                <ParallaxLayer
                    ...
                    <div className=" hidden md:flex justify-start items-center h-full mr-auto pl-20 lg:text-3xl md:text-2xl  text-sm font-light ">
                        <h1 className="text-black md:p-5 p-2 text-center  bg-white rounded-lg shadow-2xl h-20 lg:w-96  w-80">{item.title}</h1>
                    </div>
                </ParallaxLayer>))
            }
            {services.map((item, index) => (
