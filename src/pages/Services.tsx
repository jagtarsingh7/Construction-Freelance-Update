...
function Services() {
    ...
    return (
        ...
        <Parallax
            ...
            className="bg-white"
        >
            <Banner parallaxEffect={true} heading={"Engineering Services"} subHeading={"Building the Future with Engineering"} direction1={"Y"} direction2={"Y"}
                speed1={500} speed2={500} level1={50} level2={-50}
                backgroundImageName={"site4.jpg"} extraLayer={false}
                customCss1={"underline text-white text-center md:border-8 border-4 lg:p-24 md:p-20 hover:shadow-2xl shadow-inner p-12 mt-10 border-black bg-gray-100 bg-opacity-10 xl:text-8xl md:text-7xl text-5xl font-serif "}
                customCss2={"text-balck text-center md:text-3xl text-xl underline font-serif"}   >
                <ScrollButton to={1} page={parallax} parallaxEffect={true} target={null}></ScrollButton>
            </Banner>

            <ParallaxLayer
                offset={1}
                speed={0.4}
                className=" flex flex-col justify-center text-yellow-500 "
            >
                <h1 className="pt-20 m-2 underline xl:text-7xl md:text-5xl  text-2xl font-mono  mb-4">Services</h1>
                <p className="text-center md:text-lg text-sm font-serif mb-8">
