...
function Projects() {
  ...
  return (
    animation ? (
      <Parallax className="bg-black" ref={parallax} pages={pics.length} horizontal>
        ...
        <ParallaxLayer
          ...
          <Image width={500} height={500} src={"/images/logo.png"} alt="project" className=" h-1/4 w-1/4 border-8  bg-white shadow-xl " />
        </ParallaxLayer>
